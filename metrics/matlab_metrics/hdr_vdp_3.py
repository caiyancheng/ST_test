...
class hdrvdp3_metric(vq_metric):
    ...
    def predict_video_source(self, vid_source, frame_padding="replicate"):
        ...
        for ff in range(N_frames):
            ...
            with tempfile.NamedTemporaryFile(mode='w+b', prefix='HDR-VDP-3' + "-", suffix=".mat") as tf:
