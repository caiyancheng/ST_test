...
"""
PieAPP metric. Usage is same as the FovVideoVDP metric (see pytorch_examples).
"""
...
class pieapp_metric(vq_metric):
    ...
    def __init__(self, device=None):
        ...
        self.metric = create_metric('pieapp', device=self.device)
